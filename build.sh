...
${CROSS_TC}-gcc ${CFLAGS} ${LDFLAGS} libopenlipclua.o -shared -o libopenlipclua.so -Wl,-soname=libopenlipclua.so -Wl,--warn-unresolved-symbols -Wl,--no-as-needed -L. -l:liblipc.so
